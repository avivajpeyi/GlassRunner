...
namespace Facebook.Unity.Example
{
    ...
    internal class GraphRequest : MenuBase
    {
        ...
        protected override void GetGui()
        {
            ...
            if (this.Button("get Score"))
            {

                score = 0;
                FB.API("/me/score", HttpMethod.GET, this.ScoreCallback);
                
            }
            
            if (this.Button("Increase score"))
            {
                ...
                FB.API(
                    "/me/scores",
                    method: HttpMethod.POST, this.HandleResult, scoreData);
        ...
        private void ScoreCallback(IGraphResult result)
        {
            ...
            {
                this.score = int.Parse( result.RawResult);
            }
